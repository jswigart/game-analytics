...
public:
	...
	void setUserData( const char * name, const QVariant &data );
	QVariant getUserData( const char * name );
...
Q_SIGNALS:
	...
	QtBrowserItem *addProperty( QtProperty *property, QtProperty *parent );
