...
public:
	...
	// customized version that stores user data about met
	virtual QtVariantProperty *addMetaProperty( int propertyType, QObject* obj, const QMetaProperty& metaProperty );
...
private:
	...
	Q_PRIVATE_SLOT( d_func(), void slotRangeChanged( QtProperty *, const QVector3D &, const QVector3D & ) )
