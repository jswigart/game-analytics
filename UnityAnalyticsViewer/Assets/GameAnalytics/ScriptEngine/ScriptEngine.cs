...
{
    static public class EngineWrapper
    {
    ...
    {
        public virtual void PrintSomething() { Debug.LogFormat("TestEntity");  }
    }
    ...
    public class ScriptEngine : MonoBehaviour
    {
        ...
        public TextAsset ScriptEntities;
        public TextAsset ScriptEval;
        ...
        void TestEvaluator()
        {
            Run(ScriptEntities.text);

            ScriptEntity val;
            Evaluate<ScriptEntity>(ScriptEval.text, out val);            
        }
        ...
        public bool Run(string code)
        {
            ...
            var error = _stringBuilder.ToString();
        ...
        {
            _evaluator.ImportTypes(false, types);
            //_importer.ImportTypes(types, _module.GlobalRootNamespace, false);
        }
